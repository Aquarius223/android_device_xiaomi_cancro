...
case "$powermode" in
        ...
        echo 80            > /sys/module/cpu_boost/parameters/boost_ms
    ...
    "1")
        ...
        echo "16000 1400000:42000 1500000:38000 1700000:19000" > /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay
